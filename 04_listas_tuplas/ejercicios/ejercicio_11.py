"""
Ejercicio 11 - Emparejar sensores

Objetivo:
Practicar emparejar sensores en un contexto util para Python, sensores o automatizacion.
...
Instrucciones:
Usa tuplas para guardar nombre y lectura.
