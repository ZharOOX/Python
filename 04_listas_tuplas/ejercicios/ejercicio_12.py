"""
Ejercicio 12 - Dos listas relacionadas

Objetivo:
Practicar dos listas relacionadas en un contexto util para Python, sensores o automatizacion.
...
Instrucciones:
Recorre nombres y valores con zip.
...
Restricciones:
- zip une elementos por posicion.
