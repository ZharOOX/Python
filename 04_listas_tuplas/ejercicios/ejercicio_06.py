"""
Ejercicio 06 - Recorrer lecturas

Objetivo:
Practicar recorrer lecturas en un contexto util para Python, sensores o automatizacion.
...
Instrucciones:
Recorre una lista e imprime cada lectura con unidad.
