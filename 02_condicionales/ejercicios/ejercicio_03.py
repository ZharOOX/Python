"""
Ejercicio 03 - Rango seguro

Objetivo:
Practicar rango seguro en un contexto util para Python, sensores o automatizacion.
...
Instrucciones:
Clasifica temperatura como baja, normal o alta.
